...
public class ViewFullscreenVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBetterVideoPlayer.setLoadingStyle(2);
        mBetterVideoPlayer.setSource(Uri.parse(getIntent().getStringExtra("VIDEOURI")));
    ...
    public void onBackPressed() {
        ...
        i.putExtra("CHATROOM",getIntent().getStringExtra("CHATROOM"));
        i.putExtra("CHATWITH",getIntent().getStringExtra("CHATWITH"));
        i.putExtra("CHATUSERNAME",getIntent().getStringExtra("CHATUSERNAME"));
        startActivity(i);
        finish();
    }
